...
export default function TopSideInfoComponent() {
    ...
    return(
        <div>
            <TextComponent fontSize={18} fontWeight={300} color={'white'} marginTop={0} marginBottom={10}>This Page Is Made With :</TextComponent>
            <ListComponent>
            ...
            <TextComponent fontSize={40} fontWeight={900} color={'white'} marginTop={10} marginBottom={18}>By Mahdi Tasha</TextComponent>
